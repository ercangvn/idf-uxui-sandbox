	...
	public interface Template extends SafeHtmlTemplates {
		...
		@Template("<div class='person-cell'>"
					...
					+ "<section class='person-cell__content'>"
						+ "<div class='education'>"
							+ "<div class='person-cell__item university' title='University'><span class='person-cell__label'>University</span>{7}</div>"
						+ "</div>"
						+ "<div class='work'>"
							+ "<div class='person-cell__item job-title' title='Job Title'><span class='person-cell__label'>Job Title</span>{10}</div>"
							+ "<div class='person-cell__item company' title='Company'><span class='person-cell__label'>Company</span>{13}</div>"
							+ "<div class='person-cell__item department' title='Department'><span class='person-cell__label'>Department</span>{14}</div>"
							+ "<div class='person-cell__item linkedin-skill' title='LinkedIn Skill'><span class='person-cell__label'>LinkedIn Skill</span>{11}</div>"
							+ "<div class='person-cell__id ein' title='Employer Identification Number'><i class='bi bi-hash'></i>{15}</div>"
						+ "</div>"
					...
					+ "<footer class='person-cell__nav'>"
							+ "<div class='email' title='E-Mail'><a class='person-cell__mail' href='mailto:{9}'><i class='bi bi-envelope-at mr-4'></i>{9}</a></div>"
					+ "</footer>"
				+ "</div>")
		//@formatter:on
